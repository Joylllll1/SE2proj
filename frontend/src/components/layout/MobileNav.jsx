...
function MobileNav({ activePage, onNavigate }) {
  ...
  return (
    <nav className="mobile-nav lg:hidden fixed right-3 bottom-3 left-3 z-50 grid grid-cols-4 gap-1 p-2 border border-line rounded-[20px] bg-white/92 backdrop-blur-xs shadow-md">
      {items.map((item) => (
